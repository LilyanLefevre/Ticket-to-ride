...
public class DrawPane extends JPanel {
    ...
    public DrawPane(Game g) {
        ...
        piocheDestination.add(new CardImagePane("dos-destination.png",-1));
        ...
        piocheWagon.add(new CardImagePane("dos-wagon.png",-1));
        ...
        for(int i = 0; i < g.getDrawVisibleTrainCards().size(); i++){
            switch (g.getDrawVisibleTrainCards().get(i).getColor()){
                case RED:
                    CardImagePane tmp = new CardImagePane("wagon-rouge.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case BLACK:
                    tmp = new CardImagePane("wagon-noir.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case BLUE:
                    tmp = new CardImagePane("wagon-bleu.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case GREEN:
                    tmp = new CardImagePane("wagon-vert.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case WHITE:
                    tmp = new CardImagePane("wagon-blanc.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case ORANGE:
                    tmp = new CardImagePane("wagon-orange.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case PURPLE:
                    tmp = new CardImagePane("wagon-violet.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case YELLOW:
                    tmp = new CardImagePane("wagon-jaune.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                case RAINBOW:
                    tmp = new CardImagePane("locomotive.png", i);
                    cartesVisibles.add(tmp);
                    piocheVisibleWagon.add(tmp);
                    break;
                default:
